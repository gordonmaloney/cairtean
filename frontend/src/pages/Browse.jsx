...
export const Browse = () => {
  ...
  const handleCheck = (card) => {
    if (checkedCards.includes(card)) {
      setCheckedCards(
        checkedCards.filter((checkedCard) => checkedCard._id != card._id)
      );
    } else if (!checkedCards.includes(card)) {
  ...
  const handleBulkDelete = () => {
    dispatch(bulkDelete(checkedCards));
    ...
    <div>
            ...
            <table>
              <tbody>
                ...
                {[...cards]
                  ...
                  .map((card, index) => {
                    return (
                      <tr key={index} className="wordRow">
                        <td
                          style={{
          ...
          {checkedCards.length > 0 && (
            <span
              style={{
                ...
                padding: "20px",
                borderRadius: "10px",
                border: `1px solid ${MUIStyle.black}`,
            ...
            >
              ...
              <Button
                variant="contained"
                sx={{ ...MUIStyle.ButtonStyleCancel, margin: "5px" }}
              ...
              <Button
                variant="contained"
                sx={{ ...MUIStyle.ButtonStyle, margin: "5px" }}
                onClick={() => {
                  setCheckedCards([]);
                }}
              >
      ...
      >
        <Box sx={{ ...MUIStyle.ModalStyle, backgroundColor: "#fffffe" }}>
          ...
          <br />
          <p>
            Are you <em>sure</em> you want to remove all {checkedCards.length}{" "}
            selected cards? This cannot be undone.
          </p>
          <br />
          <br />
          <center>
